...
function flattenTrialData(trial, id) {
    ...
    out.advisorAnswer = trial.advisorAnswer;
    out.advisorCorrect = trial.advisorCorrect;
    out.advisorConfidence = trial.advisorConfidence;
    out.whereLarger = trial.whereLarger;
    out.leftGrid = trial.leftGrid;
    out.rightGrid = trial.rightGrid;
    out.trialSelect = trial.trialSelect;
